...
const Home = ({ setIsAuthenticated }) => {
  ...
  return (
    <Container
      ...
      style={{
        backgroundImage: "url('https://source.unsplash.com/1600x900/?technology,security')",
        ...
        <Card.Body className="text-center">
          ...
          <Form onSubmit={handleLogin}>
            ...
            <Form.Group className="mb-3">
              ...
              <InputGroup>
                <InputGroup.Text className="bg-warning text-dark border-0">
                  <FaUserShield />
                </InputGroup.Text>
                <Form.Control
                  type="email"
                  placeholder="Enter email"
                  className="bg-dark text-white border-0 rounded-end"
                  value={email}
